...
$(document).ready(function () {
    ...
    $("#countdown").countdown({
        date: "12 March 2019 00:00:00", // Change this to your desired date to countdown to
        format: "on"
    ...
    $('#circleS').circleProgress({
        startAngle: -Math.PI * 0.5,
        animationStartValue: seconds / 60,
        value: 0,
        size: 150,
        fill: {
            gradient: ["#fff", "#FACB15"]
